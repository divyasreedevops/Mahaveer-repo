...
export function LandingPage() {
  ...
  useEffect(() => {
    if (isAuthenticated && userType === 'patient') navigate('/patient/dashboard', { replace: true });
    if (isAuthenticated && userType === 'admin') navigate('/admin/dashboard', { replace: true });
  ...
  const sponsors = [
    ...
    { 
      name: 'Novartis',
      logo: 'https://images.unsplash.com/photo-1728470164693-95f5e7bade80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpY2luZSUyMGBoYXJtYWNldXRpY2FsJTIwY29tcGFueXxlbnwxfHx8fDE3NzAzNzUxMTN8MA&ixlib=rb-4.1.0&q=80&w=1080'
    },
    { 
      name: 'Lupin',
      ...
      <div className="fixed bottom-0 w-screen left-0 py-6 overflow-hidden bg-white border-t border-gray-100 z-10">
        ...
        <div className="relative">
          <div className="flex animate-scroll hover:[animation-play-state:paused] space-x-8">
            {/* Triple the sponsors array for seamless loop */}
