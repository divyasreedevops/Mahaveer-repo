...
import { PrescriptionApprovalsList } from './PrescriptionApprovalsList';
    ...
    <div className="min-h-screen bg-blue-50">
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="container mx-auto px-4 py-4 max-w-6xl flex justify-between items-center">
          ...
          <Button variant="outline" onClick={logout} className="border-gray-100">
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="approvals" className="space-y-6">
            <TabsList className="bg-white border border-gray-100 shadow-sm">
              <TabsTrigger value="approvals" className="data-[state=active]:bg-purple-50 data-[state=active]:text-purple-700">KYC Approvals</TabsTrigger>
              <TabsTrigger value="prescriptions" className="data-[state=active]:bg-purple-50 data-[state=active]:text-purple-700">Prescriptions</TabsTrigger>
